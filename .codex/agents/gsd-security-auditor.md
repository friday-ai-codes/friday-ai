...
**Verification depth scales with `asvs_level`** (see @/Users/zaneliu/Projects/open-source/friday-clean/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
