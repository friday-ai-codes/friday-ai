...
<reference>
@/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/references/user-profiling.md` to load:
