...
- Usage: Reference from command with `@/Users/example/Projects/open-source/friday-ai/.codex/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/example/Projects/open-source/friday-ai/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/example/Projects/open-source/friday-ai/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
