...
<!-- For checkpoint task examples and patterns, see @/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/references/checkpoints.md -->
...
See `/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
