...
The keys live in `.codex/settings.json` (project) or `/Users/example/Projects/open-source/friday-clean/.codex/settings.json` (global) — **not** in `.planning/config.json`:
