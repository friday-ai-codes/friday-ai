...
The keys live in `.codex/settings.json` (project) or `/Users/zaneliu/Projects/open-source/friday-clean/.codex/settings.json` (global) — **not** in `.planning/config.json`:
