...
- **Global scope**: `/Users/example/Projects/open-source/friday-ai/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/example/Projects/open-source/friday-ai/.codex/notes/`)
...
2. Glob `/Users/example/Projects/open-source/friday-ai/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/example/Projects/open-source/friday-ai/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/example/Projects/open-source/friday-ai/.codex/notes/` — works in any directory
