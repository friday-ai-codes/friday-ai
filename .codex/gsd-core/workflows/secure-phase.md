...
```
Agent(
  prompt="Read /Users/zaneliu/Projects/open-source/friday-clean/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/zaneliu/Projects/open-source/friday-clean/.codex/gsd-core/templates/SECURITY.md`
