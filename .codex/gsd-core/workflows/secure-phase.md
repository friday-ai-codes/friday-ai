...
```
Agent(
  prompt="Read /Users/example/Projects/open-source/friday-ai/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/example/Projects/open-source/friday-ai/.codex/gsd-core/templates/SECURITY.md`
