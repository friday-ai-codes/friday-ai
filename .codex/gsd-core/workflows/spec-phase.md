...
ones). Reference: @/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/example/Projects/open-source/friday-clean/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/example/Projects/open-source/friday-clean/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/templates/spec.md.
