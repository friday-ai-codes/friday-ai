...
```bash
INIT=$(node "/Users/zaneliu/Projects/open-source/friday-ai/.codex/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/zaneliu/Projects/open-source/friday-ai/.codex/gsd-core/templates/spec.md.
