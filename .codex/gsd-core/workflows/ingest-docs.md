...
```bash
INIT=$(node "/Users/example/Projects/open-source/friday-ai/.codex/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/example/Projects/open-source/friday-ai/.codex/gsd-core/bin/gsd-tools.cjs" commit \
