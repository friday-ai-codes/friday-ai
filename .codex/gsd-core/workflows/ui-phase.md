...
```markdown
Read /Users/example/Projects/open-source/friday-clean/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/example/Projects/open-source/friday-clean/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/example/Projects/open-source/friday-clean/.codex/agents/gsd-ui-checker.md for instructions.
...
@/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/example/Projects/open-source/friday-clean/.codex.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/example/Projects/open-source/friday-clean/.codex/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
