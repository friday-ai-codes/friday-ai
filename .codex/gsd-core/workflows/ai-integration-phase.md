...
<required_reading>
@/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/references/ai-frameworks.md
@/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/example/Projects/open-source/friday-clean/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/example/Projects/open-source/friday-clean/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/example/Projects/open-source/friday-clean/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/example/Projects/open-source/friday-clean/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/example/Projects/open-source/friday-clean/.codex/agents/gsd-eval-planner.md for instructions.
