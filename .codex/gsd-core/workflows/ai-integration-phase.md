...
<required_reading>
@/Users/zaneliu/Projects/open-source/friday-clean/.codex/gsd-core/references/ai-frameworks.md
@/Users/zaneliu/Projects/open-source/friday-clean/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-clean/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/zaneliu/Projects/open-source/friday-clean/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-clean/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-clean/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-clean/.codex/agents/gsd-eval-planner.md for instructions.
