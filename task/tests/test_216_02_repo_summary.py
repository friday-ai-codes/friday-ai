"""initial implementation plan: 容器侧 repo_summary 模式测试。
...
class TestGitTokenAuth:
    ...
    async def test_gitlab_token_is_url_encoded_in_password_position(self):
        config = TaskConfig(
            ...
            task_description="test",
            git_repo_url="git@gitlab.example.com:frontend/onion-practice.git",
            git_auth_type="token",
        ...
        assert config.git_repo_url == (
            ...
            "@gitlab.example.com/frontend/onion-practice.git"
        )
