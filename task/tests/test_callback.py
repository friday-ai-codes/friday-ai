...
class TestRunExecuteModeReportsCompleted:
 ...
 config.branch_strategy = "fix20260528.tabstudy-gift-aftersearch-slot"
 ...
 return_value="fix20260528.tabstudy-gift-aftersearch-slot"
 )
 ...
 branch_strategy="fix20260528.tabstudy-gift-aftersearch-slot",
 task_id="legacy-001",
 )
 runner.git_ops.push_branch_with_retry.assert_awaited_once_with(
 "fix20260528.tabstudy-gift-aftersearch-slot"
 )
 @pytest.mark.asyncio
 ...
 runner.claude.get_session_summary = AsyncMock(return_value="plan summary")
 runner.claude.run_execute_mode = AsyncMock(return_value={"success": True})
 result = await runner._run_execute_mode(MagicMock, "fix20260528.expected")
 assert result == 1
 runner.git_ops.commit_changes.assert_not_called
 ...
 result = await runner._run_execute_mode(MagicMock, "fix20260528.expected")
 assert result == 0
 runner.git_ops.restore_task_branch.assert_awaited_once_with("fix20260528.expected")
