 ...
 * -:project-id 不传（系统级页面）
 *
 * 路由元信息（ RBAC）：requiresAdmin: true → 全局导航守卫拦截非 admin
 */
...
const columns: ColumnDef<PromptListItem> = [
 ...
 ? h(Badge, { variant: 'secondary' }, => '系统内置'): null,
 },
]
</script>
<template>
 ...
 <DataTable:data="systemList":columns="columns"
 table-id="admin-prompts-list":loading="loading":on-row-click="openRow"
 >
 <template #filters>
 ...
 <PromptEditor
 v-model:open="sheetOpen":mode="editorMode"
 />
 </PageContainer>
</template>
