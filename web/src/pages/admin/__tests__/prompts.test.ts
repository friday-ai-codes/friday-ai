/**
 * pages/admin/prompts/index.vue 集成测试 —— Phase Plan Task 1
 *
 * 覆盖路径（Plan Task 1 behavior §1-§9）：
...
// Tests
// ============================================================================
describe('pages/admin/prompts/index.vue ', => {
 beforeEach( => {
 ...
 mocks.systemListRef.value = [makeListItem, makeListItem({ id: '', slug: 'chat.system.code_review' })]
 const wrapper = mountPage
 await nextTick
