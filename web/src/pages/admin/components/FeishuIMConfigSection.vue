  ...
  <section class="group relative">
    <div class="card overflow-hidden">
      ...
      <div class="p-6 space-y-6">
        <!-- 说明 -->
        <div class="rounded-lg bg-primary/5 border border-primary/20 p-4 text-sm text-muted-foreground space-y-2">
        ...
        <div class="space-y-3">
          ...
          <div class="relative">
            ...
            <Input
              id="feishu-app-id"
              :model-value="props.feishuAppIdValue"
        ...
        <div class="space-y-3">
          ...
          <div class="relative">
            ...
            <Input
              ...
              :model-value="props.feishuAppSecretValue"
              :type="props.showFeishuAppSecret ? 'text' : 'password'"
              :placeholder="props.getSettingByKey(SettingKey.FEISHU_APP_SECRET)?.has_value ? '••••••••••••••••' : '输入 App Secret'"
              class="pl-10 pr-10 h-11 font-mono text-sm bg-muted/30 border-border/50 focus:border-primary/50"
      ...
      <div class="flex justify-between px-6 py-4 border-t border-border/50">
        ...
        <div v-else />
        <Button
          :disabled="props.savingFeishuIM || (!props.feishuAppIdDirty && !props.feishuAppSecretDirty)"
          @click="emit('save')"
        >
