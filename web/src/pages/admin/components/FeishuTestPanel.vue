    ...
    <div class="space-y-3">
      <div class="space-y-1.5">
        ...
        <div class="flex gap-4">
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              :checked="props.feishuTestReceiveIdType === 'open_id'"
              type="radio"
              value="open_id"
          ...
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              :checked="props.feishuTestReceiveIdType === 'chat_id'"
              type="radio"
              value="chat_id"
              class="accent-primary"
      ...
      <div class="space-y-1.5">
        ...
        <div class="relative">
          ...
          <Input
            :model-value="props.feishuTestReceiveId"
            :placeholder="props.feishuTestReceiveIdType === 'chat_id' ? 'oc_xxxxxxxxxx' : 'ou_xxxxxxxxxx'"
            class="pl-10 h-10 font-mono text-sm bg-background border-border/50"
      ...
      <div class="space-y-1.5">
        ...
        <Textarea
          :model-value="props.feishuTestMessage"
          rows="2"
      ...
      <div class="flex items-center gap-3">
        <Button
          variant="outline"
          size="sm"
          :disabled="props.testingFeishuIM"
          @click="emit('test')"
        >
        ...
        <div
          ...
          :class="props.feishuTestResult.success ? 'bg-emerald-500/10 text-emerald-600' : 'bg-destructive/10 text-destructive'"
        >
