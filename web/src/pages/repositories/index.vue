  ...
  <PageContainer>
    ...
    <div v-else class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      >
        <!-- 索引状态顶部指示条 -->
        <div
          class="h-0.5 rounded-t-[inherit]"
          :class="{ 'bg-emerald-500': repository.index_status === 'indexed', 'bg-blue-500 animate-pulse': repository.index_status === 'indexing', 'bg-red-500': repository.index_status === 'failed', 'bg-border/30': repository.index_status === 'not_indexed' }"
        />
