...
<template>
  <div class="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
    ...
    <div class="absolute inset-0 -z-10">
      ...
      <div class="absolute bottom-0 -left-40 w-96 h-96 bg-gradient-to-tr from-secondary/30 to-primary/10 rounded-full blur-3xl" />
    </div>
    ...
    <div class="w-full max-w-md px-4">
      ...
      <div
        ...
        class="rounded-2xl bg-card/80 backdrop-blur-sm border border-destructive/30 p-8 text-center space-y-4"
      >
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-destructive/10">
      ...
      <div
        ...
        class="rounded-2xl bg-card/80 backdrop-blur-sm border border-green-500/30 p-8 text-center space-y-4"
      >
