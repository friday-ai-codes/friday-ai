  ...
  <div class="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
    ...
    <div class="w-full max-w-md mx-4">
      <div class="relative">
        <!-- 卡片光晕 -->
        <!-- 卡片主体 -->
        <div class="relative bg-card/80 backdrop-blur-xl rounded-2xl border border-border/50 shadow-2xl shadow-amber-500/5 p-8">
          <!-- Logo -->
          <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center p-3 mb-4 rounded-2xl bg-gradient-to-br from-amber-500/10 via-orange-500/20 to-amber-500/10 border border-amber-500/20">
          ...
          <form class="space-y-5" @submit="onSubmit">
            ...
            <div
              v-if="submitError"
              class="flex items-center gap-3 p-4 rounded-xl bg-destructive/10 border border-destructive/20 text-destructive"
            >
            ...
            <!-- 警告提示 -->
            <div class="flex items-center gap-3 p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-700">
                ...
                <FormControl>
                  <div class="relative">
                    ...
                    <Input
                      ...
                      class="pl-10 h-11 bg-muted/30 border-border/50 focus:border-amber-500/50 focus:ring-amber-500/20"
            ...
            <Button
              type="submit"
              class="w-full h-11 text-base font-medium hover:from-amber-600 hover:to-orange-600 group relative overflow-hidden"
