 ...
 * Prompts Store
 *
 * 数据层基石。覆盖 Prompt CRUD / Preview / Versions API，
 * 并通过 `mergedSpaceList` computed 实现 D-06 的三态合并（overridden/fallback/project_only）。
 *
...
/**
 * 空间级合并后的列表项（D-06 mergedSpaceList 派生结构）
 */
