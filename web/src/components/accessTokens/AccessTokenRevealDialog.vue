...
/**
 * Access Token 一次性明文展示弹窗（Phase，安全核心 T-/02）
 *
...
<template>
 ...
 <div class="space-y-4">
 <!-- 一次性警告框 -->
 <div class="rounded-xl border border-amber-200 bg-amber-50 text-sm text-amber-700 dark:border-amber-800 dark:bg-amber-950/30 dark:text-amber-400">
 ...
 <code class="flex-1 break-all rounded-lg bg-muted font-mono text-sm">{{ token }}</code>
