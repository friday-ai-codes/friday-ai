      ...
      <tbody class="divide-y divide-border/50">
        ...
        >
          ...
          <td class="hidden lg:table-cell px-4 py-3.5">
            ...
            >
              <span class="icon-[lucide--infinity] h-3 w-3" aria-hidden="true" />
              永不过期
            </span>
          ...
          <td class="px-4 py-3.5 text-right">
            <Button
              ...
              @click="emit('revoke', t)"
            >
              <span class="icon-[lucide--ban] mr-1.5 h-3.5 w-3.5" aria-hidden="true" />
              吊销
            </Button>
          </td>
        </tr>
