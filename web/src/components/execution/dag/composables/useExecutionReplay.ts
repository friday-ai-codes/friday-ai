...
export function useExecutionReplay(
 ...
 ? new Date(ne.started_at).getTime - startMs.value: null
 const neEnd = ne.completed_at
 ? new Date(ne.completed_at).getTime - startMs.value: null
 ...
 */
 ...
 ? new Date(nodeExecution.started_at).getTime - execStart: null
 const neEnd = nodeExecution.completed_at
 ? new Date(nodeExecution.completed_at).getTime - execStart: null
