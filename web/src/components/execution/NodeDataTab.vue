...
<template>
 ...
 @click="enterMockMode"
 >
 <span class="icon-[lucide--flask-conical] w-3.5 .5 mr-1" />
 Mock 输出
 </Button>
 </template>
 </div>
 ...
 ? 'bg-blue-500/10 text-blue-400 border border-blue-500/30': 'bg-purple-500/10 text-purple-400 border border-purple-500/30'"
 >
 ...
 <span class="icon-[lucide--alert-circle] w-3.5 .5" />
 JSON 格式错误: {{ jsonError }}
 </div>
 <!-- 下游变量警告 -->
 ...
 variant="secondary"
 size="sm"
 class=" text-xs":disabled="!!jsonError || !isDirty"
 @click="handleSave"
 >
 <span class="icon-[lucide--save] w-3.5 .5 mr-1" />
 ...
 <Button
 size="sm"
 class="w-full text-xs":disabled="!!jsonError"
 @click="handleRelease"
 >
 ...
 <Button
 size="sm"
 class=" text-xs":disabled="!!jsonError"
 ...
 variant="outline"
 size="sm"
 class="w-full text-xs border-amber-500/30 text-amber-400 hover:bg-amber-500/10"
 @click="handleAIRealExecute"
 >
 <span class="icon-[lucide--zap] w-3.5 .5 mr-1" />
 真实执行
 </Button>
 </div>
 </template>
 ...
 <!-- AI 安全确认对话框 -->
 <AISafetyConfirm
 v-model:open="showAISafetyDialog":node-name="nodeExecution.node_name"
