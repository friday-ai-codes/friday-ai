  ...
  <div class="card card overflow-hidden">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="bg-primary/10 rounded-lg p-2">
            <span class="icon-[lucide--check-circle] w-5 h-5 text-amber-500" />
          </div>
          <div>
        ...
        >
          <span class="icon-[lucide--hourglass] w-3 h-3 mr-1" />
          待审批
        </Badge>
      </div>
    </div>
    ...
    <div class="p-5 space-y-4">
      ...
      <div
        ...
        class="p-3 rounded-xl bg-red-500/5 border border-red-500/20"
      >
        <div class="text-xs font-medium text-red-600 mb-1 flex items-center gap-1.5">
          <span class="icon-[lucide--message-circle] w-3.5 h-3.5" />
          驳回理由
        </div>
      ...
      <div v-if="isWaiting" class="flex items-center gap-3 pt-1">
        <Button
          ...
          @click="handleApprove"
        >
          <span class="icon-[lucide--check] w-4 h-4 mr-2" />
          通过
        </Button>
        <Button
          :disabled="submitting"
        ...
        >
          <span class="icon-[lucide--x] w-4 h-4 mr-2" />
          驳回
        </Button>
      </div>
    </div>
