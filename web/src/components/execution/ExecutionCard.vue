...
<template>
 <RouterLink:to="`/executions/${execution.id}`"
 ...
 <!-- Card -->
 <div
 class="relative rounded-2xl bg-card/70 backdrop-blur-sm border border-border/50 group-hover:border-primary/30 group-hover:shadow-lg group-hover:shadow-primary/5 transition-all duration-300"
 >
