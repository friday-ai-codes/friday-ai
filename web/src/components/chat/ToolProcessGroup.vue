...
<template>
 <div
 class="tpg":class="{ 'tpg--running': isRunning, 'tpg--flash': flashing }":data-process-group="groupId"
 >
 ...
 <span
 class="icon-[lucide--chevron-right] tpg-caret":class="expanded ? 'rotate-90': ''"
 />
 </button>
 ...
 class="tpg-row":class="[`tpg-row--${step.kind}`, { 'is-open': expandedRows.has(step.id) }]"
 >
 <button
 type="button"
 class="tpg-row-head":class="{ 'is-interactive': rowExpandable(step) }":disabled="!rowExpandable(step)"
 ...
 class="icon-[lucide--chevron-right] tpg-row-caret":class="expandedRows.has(step.id) ? 'rotate-90': ''"
 />
 </button>
