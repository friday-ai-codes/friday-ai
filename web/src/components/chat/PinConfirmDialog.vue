 ...
 *   - 按钮：取消 / 确认切换
 *
 * Analog: web/src/components/chat/ExportConfirmDialog.vue（PATTERNS §Pattern 1 L83-135）。
...
<template>
  <Dialog :open="open" @update:open="emit('update:open', $event)">
    ...
    >
      ...
      <div class="space-y-2 rounded-lg border border-border/60 p-4">
      ...
      <div
        v-if="errorMsg"
        class="mt-2 p-3 rounded-lg border border-destructive/30 bg-destructive/5 flex items-start gap-2 animate-fade-in"
      >
