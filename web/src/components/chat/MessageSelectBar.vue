...
/**
 * 多选模式操作条 -- 显示选中消息数、全选/取消/导出操作 (per D-01, D-02, D-05)。
 */
...
<template>
  <div class="sticky top-0 z-10 bg-background/95 backdrop-blur-sm h-12 flex items-center px-4 border-b border-border/30 animate-slide-down">
    <!-- 左侧: 选中计数 -->
