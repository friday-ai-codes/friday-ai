 ...
 *
 * 嵌入 Diff 摘要（D-18: Collapsible + 文件列表，D-19: 截断提示，D-20: 绿/红数字）。
...
/** Textarea 自动调高，最大 300px (per UI-SPEC) */
...
<template>
  ...
  <div v-else class="card mt-2 animate-fade-in">
    ...
    <div class="p-4 space-y-3">
      ...
      <!-- Diff 摘要 Collapsible (D-18/D-19/D-20) -->
