...
<template>
 ...
 <!-- Vue Flow 画布 -->
 <VueFlow
 v-else:nodes="flowNodes":edges="flowEdges":node-types="nodeTypes":min-zoom="0.2":max-zoom="2.0":fit-view-on-init="true":pan-on-scroll="false":prevent-scrolling="true":nodes-draggable="true"
 >
 <Background />
 <Controls />
 <MiniMap />
 ...
 size="sm"
 variant="outline"
 class="bg-card/90 backdrop-blur-sm text-xs ":disabled="loading2hop || currentHop === 2"
 @click="expandToHop2"
 >
 <span v-if="loading2hop" class="icon-[lucide--loader-circle] animate-spin mr-1.5 w-3.5 .5" />
