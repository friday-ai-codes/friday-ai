...
<template>
 ...
 <Button:disabled="hostSaving || !hostDirty"
 @click="saveHost"
 >
 ...
 <div class="rounded-xl bg-muted/30 border border-border/30 text-center">
 ...
 <tbody>
 <tr
 v-for="(val, key) in systemInfo.environment":key="key"
 ...
 <Button
 variant="outline":disabled="downloadingBackup"
 ...
 >
 <Button
 variant="default":disabled="!restoreFile || restoring"
 @click="handleRestore"
 >
