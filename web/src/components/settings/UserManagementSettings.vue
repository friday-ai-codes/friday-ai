      ...
      <div class="card overflow-hidden">
        ...
        <div class="p-6 space-y-4">
          ...
          >
            ...
            <p class="text-sm font-mono break-all text-muted-foreground bg-background/50 rounded-lg p-2">
              {{ inviteLink }}
            </p>
          </div>
        </div>
              ...
              <div class="flex items-center gap-3">
                ...
                <div>
                  <div class="flex items-center gap-2">
                    ...
                    <span
                      :class="user.is_active ? 'bg-green-500/10 text-green-600' : 'bg-destructive/10 text-destructive'"
