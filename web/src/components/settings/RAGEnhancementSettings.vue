    ...
    <div class="card overflow-hidden">
      ...
      <div v-else class="p-6 space-y-8">
        ...
        <div class="space-y-4">
          ...
          <div class="rounded-xl bg-muted/30 border border-border/30 p-4 space-y-3">
            <p class="text-sm text-muted-foreground">
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2 text-sm font-medium text-muted-foreground">
              ...
              <span
                v-if="rerankerHealth"
                :class="[getHealthStatusIcon(rerankerHealth.status), getHealthStatusColor(rerankerHealth.status)]"
              />
            </div>
            <Switch
