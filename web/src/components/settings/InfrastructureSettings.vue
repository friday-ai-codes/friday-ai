...
<template>
 ...
 <div class="relative">
 <span
 class="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground":class="field.type === 'password' ? 'icon-[lucide--lock]': 'icon-[lucide--link]'"
 />
 <Input:id="field.key"
 v-model="values[field.key]":type="field.type === 'password' && !showPassword[field.key] ? 'password': 'text'":placeholder="field.placeholder"
 ...
 <Button
 size="sm":disabled="!dirty[field.key] || saving[field.key]"
