      ...
      <div class="p-6">
        ...
        <div v-else class="space-y-3">
          <div
            ...
            :key="provider.id"
            class="flex items-center justify-between p-4 rounded-xl bg-muted/30 border border-border/30 hover:border-border/50 transition-colors"
          >
            <div class="flex items-center gap-3 flex-1 min-w-0">
              <div class="p-2 rounded-lg" :class="provider.is_active ? 'bg-emerald-500/10' : 'bg-muted'">
                <span
                  class="text-lg"
                  :class="provider.is_active ? 'icon-[lucide--shield-check] text-emerald-500' : 'icon-[lucide--shield-off] text-muted-foreground'"
                />
              </div>
              <div class="min-w-0">
            ...
            <div class="flex items-center gap-2 ml-4">
              ...
              />
              <Button variant="ghost" size="icon" class="h-8 w-8" @click="openEditDialog(provider)">
        ...
        <div class="space-y-4 py-4">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <Input v-model="form.name" placeholder="如：Okta、Azure AD" class="pl-10 h-11 bg-muted/30 border-border/50 focus:border-primary/50" />
            </div>
          </div>
          ...
          <div class="space-y-2">
            ...
            <Select v-model="form.kind">
              <SelectTrigger class="h-11 bg-muted/30 border-border/50 focus:border-primary/50">
          ...
          <div class="space-y-2">
            ...
            <div class="flex gap-2">
              <div class="relative flex-1">
                ...
                <Input v-model="form.issuer_url" placeholder="https://your-domain.okta.com" class="pl-10 h-11 bg-muted/30 border-border/50 focus:border-primary/50" />
              </div>
              <Button
                variant="outline"
                size="sm"
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <Input v-model="form.client_id" placeholder="OIDC Client ID" class="pl-10 h-11 font-mono text-sm bg-muted/30 border-border/50 focus:border-primary/50" />
            </div>
          </div>
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <Input
                ...
                class="pl-10 h-11 font-mono text-sm bg-muted/30 border-border/50 focus:border-primary/50"
              />
            </div>
          </div>
          ...
          <div class="rounded-lg bg-muted/30 border border-border/30 p-4 space-y-3">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                <Input v-model="form.authorization_endpoint" placeholder="https://..." class="pl-10 font-mono text-xs h-11 bg-muted/30 border-border/50 focus:border-primary/50" />
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                <Input v-model="form.token_endpoint" placeholder="https://..." class="pl-10 font-mono text-xs h-11 bg-muted/30 border-border/50 focus:border-primary/50" />
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                <Input v-model="form.userinfo_endpoint" placeholder="https://..." class="pl-10 font-mono text-xs h-11 bg-muted/30 border-border/50 focus:border-primary/50" />
              </div>
            </div>
          </div>
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <Input v-model="form.scopes" placeholder="openid profile email" class="pl-10 h-11 font-mono text-sm bg-muted/30 border-border/50 focus:border-primary/50" />
            </div>
          </div>
