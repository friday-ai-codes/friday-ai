  ...
  <div class="card overflow-hidden">
    ...
    <div class="p-6 space-y-6">
      ...
      <div v-else class="space-y-5">
        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            ...
            <Input
              ...
              :placeholder="hasExistingEncryptKey ? '••••••••••••••••' : '输入 Encrypt Key'"
              class="pl-10 pr-10 h-10 font-mono text-sm bg-muted/30 border-border/50"
        ...
        <!-- Signature Required -->
        <div class="flex items-center justify-between p-4 rounded-xl border border-border/30">
          <div>
        ...
        <div class="flex justify-end">
          <Button
            :disabled="saving || (!encryptKeyDirty && !signatureDirty)"
            @click="save"
          >
