/**
 * :NodeConfigPanel Provider 集成 vitest 集成测
 *
 * 覆盖:
 ...
 * 为被测载体( 四个 AI config 组件结构一致,覆盖 AIPromptConfig 即代表整体)。
 */
...
// Tests
// ============================================================================
describe('aIPromptConfig Provider 集成', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('provider_credential_id=cred-1(anthropic)→ providerTypes supports_thinking=true(D-14)', async () => {
  ...
  it('provider_credential_id=cred-2(openai_chat)→ providerTypes supports_thinking=false(D-14)', async () => {
