/**
 * 前端：AIModelConfig.apiBaseUrlError computed + error 文案渲染。
 *
 * 覆盖 SC#4（228 WR-03 认证混淆 前端 UX 路径）：
 ...
 *
 * 注：describe/it 标题首字母大写（F/G/H）遵循 -04 acceptance_criteria 锁定
 * （grep 断言 "F: useCustomApi..."），与 ChatHeader.spec.ts 一致，
