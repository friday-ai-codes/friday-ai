...
<template>
  <div class="space-y-4">
    <!-- 严格模式说明 -->
    <div
      class="p-4 rounded-xl bg-primary/10 border border-amber-200/50 dark:border-amber-800/50"
    >
    ...
    <!-- 合并同仓库任务 -->
    <div
      class="flex items-center justify-between p-4 rounded-xl bg-card/70 backdrop-blur-sm border border-border/50"
    >
    ...
    <!-- 节点行为说明 -->
    <div class="p-3 bg-secondary/50 rounded-xl text-sm space-y-1">
      <p class="font-medium">
        此节点将：
      </p>
