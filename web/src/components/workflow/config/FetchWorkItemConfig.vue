    ...
    <div class="space-y-2">
      ...
      >
        ...
        <Button
          variant="ghost"
          size="sm"
          class="h-6 text-xs text-primary hover:text-primary hover:bg-primary/20"
          @click="autoFill"
        >
          自动填充
        </Button>
      ...
      <p class="text-xs text-muted-foreground flex items-center gap-1">
        ...
        <Popover>
          <PopoverTrigger as-child>
            <button
              type="button"
              class="inline-flex items-center justify-center w-4 h-4 rounded-full bg-muted hover:bg-muted/80 transition-colors"
            >
            ...
            <div class="space-y-3">
              ...
              <div class="text-xs text-muted-foreground space-y-2">
                ...
                <div class="space-y-1.5 font-mono text-[11px]">
                  <div
                    v-for="example in variableSyntaxExamples"
                    :key="example.syntax"
