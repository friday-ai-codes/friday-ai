...
<template>
 ...
 <Button
 v-for="field in QUICK_FIELD_OPTIONS":key="field.key"
 size="sm":variant="isQuickFieldAdded(field.key) ? 'secondary': 'outline'":disabled="isQuickFieldAdded(field.key)"
 ...
 <div
 v-for="(rule, index) in extractions":key="index"
 ...
 <Input:model-value="rule.source_path"
