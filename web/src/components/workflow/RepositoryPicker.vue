...
<template>
  <div class="space-y-3">
    ...
    <div v-if="allowManualInput" class="flex gap-2">
      ...
      >
        <span class="icon-[lucide--list] w-3.5 h-3.5 mr-1" />
        从列表选择
      </Button>
      <Button
    ...
    <div v-if="inputMode === 'select'">
      ...
      <div
        ...
        class="rounded-lg border border-dashed border-border/50 bg-muted/30 p-4 text-center"
      >
        <span class="icon-[lucide--inbox] w-8 h-8 text-muted-foreground/50 mx-auto mb-2" />
      ...
      <Popover v-else v-model:open="open">
        <PopoverTrigger as-child>
          ...
          >
            ...
            <span class="icon-[lucide--chevrons-up-down] w-4 h-4 opacity-50" />
          </Button>
        </PopoverTrigger>
          ...
          <Command>
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                >
                  <span
                    class="icon-[lucide--check] w-4 h-4 mr-2 transition-opacity"
                    :class="isSelected(repo.id) ? 'opacity-100' : 'opacity-0'"
                  />
                  <span class="icon-[lucide--git-branch] w-4 h-4 mr-2 text-muted-foreground" />
