  ...
  >
    ...
    <div class="flex items-center justify-between px-6 py-5 border-b border-border/50">
      <div class="flex items-center gap-3">
        <div class="p-2.5 rounded-xl bg-gradient-to-br" :class="triggerConfig.bgGradient">
    ...
    <form class="px-6 py-5 space-y-5 overflow-y-auto" @submit.prevent="handleSubmit">
      ...
      <template v-if="requiresInput">
        ...
        <div class="space-y-3">
          ...
          <!-- 可选字段 -->
          <div v-if="optionalFields.length > 0" class="rounded-lg border border-border/50 bg-muted/20 p-3 space-y-2">
        ...
        <div class="space-y-2">
          ...
          <Textarea
            ...
            :class="{ 'border-destructive': parseError || validationErrors.length > 0 }"
          />
          ...
          <!-- 结构验证错误 -->
          <div v-if="validationErrors.length > 0" class="rounded-lg border border-destructive/50 bg-destructive/10 p-3 space-y-1">
      ...
      <template v-else>
        <div class="flex flex-col items-center py-6 text-center">
          <div class="p-4 rounded-2xl bg-primary/10 mb-4">
      ...
      <div class="flex justify-end gap-3 pt-4 border-t border-border/50">
        ...
        <div class="flex items-center gap-2 mr-auto">
          ...
          <label class="text-sm text-muted-foreground cursor-pointer select-none flex items-center gap-1" @click="debugMode = !debugMode">
            <span class="icon-[lucide--bug] w-3.5 h-3.5" />
            调试模式
          </label>
        </div>
