    ...
    <ScrollArea class="flex-1">
      <div class="p-5 space-y-4">
        ...
        <div
          v-for="task in tasks"
          :key="task.id"
          class="group p-3 border rounded-xl bg-card/70 backdrop-blur-sm border-border/50 hover:bg-accent/50 hover:border-primary/30 cursor-pointer transition-all duration-300"
          ...
          <div class="flex items-start justify-between gap-2">
            <div class="flex-1 min-w-0">
              ...
              <div
                ...
                class="mt-2 p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800"
              >
              ...
              <div
                ...
                class="mt-2 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800"
              >
                <div class="flex items-start gap-2">
                  <span class="icon-[lucide--alert-triangle] w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
                  <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center gap-2 shrink-0">
              ...
              <a
                ...
                @click.stop
              >
                <span class="icon-[lucide--git-pull-request] w-4 h-4" />
              ...
              >
                <span class="icon-[lucide--alert-triangle] w-3 h-3" />
