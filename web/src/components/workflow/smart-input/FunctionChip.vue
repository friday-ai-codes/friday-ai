...
<template>
  <NodeViewWrapper
    ...
    :class="[selected ? 'bg-blue-500 text-white border border-blue-500' : 'bg-blue-50 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800']"
  ...
  >
    ...
    <button
      ...
      :class="selected ? 'hover:bg-white/20' : 'hover:bg-blue-500/20'"
      @click="deleteNode"
    >
