    ...
    <div class="divide-y divide-border/30">
      ...
      >
        ...
        <div class="lg:col-span-5 flex items-center gap-3 min-w-0">
          <div class="shrink-0 w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
        ...
        <div class="lg:col-span-2 flex items-center gap-2">
          ...
          <span
            ...
            class="inline-flex"
            :title="getExecutionInfo(log.execution_status)?.label"
          >
        ...
        <div class="lg:col-span-1 flex items-center justify-end gap-1">
          <RouterLink
            v-if="log.first_execution_id"
            :to="`/executions/${log.first_execution_id}`"
            class="inline-flex items-center justify-center h-7 w-7 rounded-md opacity-0 group-hover:opacity-100 transition-opacity hover:bg-muted/50"
            title="查看执行"
            @click.stop
          >
