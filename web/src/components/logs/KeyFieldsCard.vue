  ...
  <div class="card border-primary/20 bg-primary/5">
    <div class="px-5 py-3.5 border-b border-border/50 flex items-center gap-2">
      <h3 class="text-sm font-semibold">
        <span class="icon-[lucide--star] h-4 w-4 text-primary" />
        关键字段
      </h3>
    </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div v-if="props.prdUrl" class="flex gap-1">
            <Button
              ...
              target="_blank"
            >
              <span class="icon-[lucide--external-link] h-3.5 w-3.5" />
            </Button>
            <Button
              variant="ghost"
              size="sm"
            ...
            >
              <span class="icon-[lucide--copy] h-3.5 w-3.5" />
            </Button>
          </div>
        </div>
