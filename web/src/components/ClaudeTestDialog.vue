      ...
      <div class="px-6 pt-5 pb-4 border-b border-border/50 shrink-0">
        <div class="flex items-center gap-3">
          <div class="relative">
            ...
            <div class="relative p-2.5 rounded-xl bg-primary/10 flex items-center justify-center">
      ...
      <div class="flex-1 overflow-y-auto px-6 py-5 space-y-5">
        ...
        <div class="space-y-3">
          ...
          <Select v-else-if="hasModels" v-model="selectedModel">
            <SelectTrigger class="h-11 bg-muted/30 border-border/50">
          ...
          <div v-else class="space-y-2">
            <div class="relative">
              ...
              <Input
                ...
                class="pl-10 h-11 bg-muted/30 border-border/50 focus:border-primary/50"
              />
            </div>
        ...
        <div
          ...
          :class="{ 'border-border/50 bg-muted/20': testStatus === 'loading', 'border-destructive/30 bg-destructive/5': testStatus === 'error', 'border-emerald-500/30 bg-primary/10 dark:from-emerald-950/20 dark:to-cyan-950/10': testStatus === 'success' }"
        >
          <!-- 加载状态 -->
          ...
          <!-- 错误状态 -->
          <div v-else-if="testStatus === 'error'" class="p-4">
            <div class="flex items-start gap-3">
              <div class="p-2 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
          ...
          <div v-else-if="testStatus === 'success' && result" class="divide-y divide-emerald-500/20">
            ...
            <div class="flex items-center gap-3 px-4 py-3">
              <div class="p-1.5 rounded-full bg-primary/10 shadow-lg shadow-emerald-500/25">
