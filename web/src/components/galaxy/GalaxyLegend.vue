...
<template>
 ...
 <!-- 折叠 toggle -->
 <button
 class="px-4 py-2.5 flex items-center gap-2 w-full text-left hover:bg-white/5 transition-colors":aria-expanded="legendOpen"
 ...
 <span
 class="icon-[lucide--chevron-down] ml-auto text-sm text-muted-foreground transition-transform duration-200":class="{ 'rotate-180': legendOpen }"
 />
 </button>
 <!-- 折叠内容 -->
 <div
 ...
 >
 <span
 class="inline-block w-3 rounded-full shrink-0":style="{ backgroundColor: n.color }"
 />
 {{ n.label }}
 </li>
 </ul>
 ...
 >
 <span
 class="inline-block w-5 .5 shrink-0 rounded-full":style="{ backgroundColor: e.color }"
 />
 {{ e.label }}
 </li>
 </ul>
