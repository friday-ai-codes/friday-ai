...
<!-- For checkpoint task examples and patterns, see @/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
