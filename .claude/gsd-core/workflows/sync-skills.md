...
INSTALL_JS_GLOBAL="/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/example/Projects/open-source/friday-ai/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
