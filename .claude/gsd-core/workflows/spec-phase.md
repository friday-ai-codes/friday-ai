...
ones). Reference: @/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/zaneliu/Projects/open-source/friday-clean/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/zaneliu/Projects/open-source/friday-clean/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/templates/spec.md.
