...
See /Users/example/Projects/open-source/friday-clean/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/example/Projects/open-source/friday-clean/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/example/Projects/open-source/friday-clean/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/example/Projects/open-source/friday-clean/.claude/gsd-core/templates/discovery.md
...
Use /Users/example/Projects/open-source/friday-clean/.claude/gsd-core/templates/discovery.md.
