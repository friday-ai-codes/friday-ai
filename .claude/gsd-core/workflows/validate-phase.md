...
```
Agent(
  prompt="Read /Users/example/Projects/open-source/friday-ai/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/templates/VALIDATION.md`
