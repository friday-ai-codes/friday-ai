...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-ai/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/zaneliu/Projects/open-source/friday-ai/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-ai/.claude/agents/gsd-ui-checker.md for instructions.
