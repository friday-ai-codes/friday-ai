...
<template>
@/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/workflows/diagnose-issues.md
