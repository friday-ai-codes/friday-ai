...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/zaneliu/Projects/open-source/friday-clean/.claude/.gsd-surface.json`
(sibling to `/Users/zaneliu/Projects/open-source/friday-clean/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/zaneliu/Projects/open-source/friday-clean/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/zaneliu/Projects/open-source/friday-clean/.claude/skills`).
...
`/Users/zaneliu/Projects/open-source/friday-clean/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/zaneliu/Projects/open-source/friday-clean/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/zaneliu/Projects/open-source/friday-clean/.claude/.gsd-surface.json`
Install profile marker: `/Users/zaneliu/Projects/open-source/friday-clean/.claude/.gsd-profile`
Skill dirs: `/Users/zaneliu/Projects/open-source/friday-clean/.claude/skills/gsd-*/`
Engine module: `/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/zaneliu/Projects/open-source/friday-clean/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
