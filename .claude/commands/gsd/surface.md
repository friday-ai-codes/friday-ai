...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/example/Projects/open-source/friday-ai/.claude/.gsd-surface.json`
(sibling to `/Users/example/Projects/open-source/friday-ai/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/example/Projects/open-source/friday-ai/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/example/Projects/open-source/friday-ai/.claude/skills`).
...
`/Users/example/Projects/open-source/friday-ai/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/example/Projects/open-source/friday-ai/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/example/Projects/open-source/friday-ai/.claude/.gsd-surface.json`
Install profile marker: `/Users/example/Projects/open-source/friday-ai/.claude/.gsd-profile`
Skill dirs: `/Users/example/Projects/open-source/friday-ai/.claude/skills/gsd-*/`
Engine module: `/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
