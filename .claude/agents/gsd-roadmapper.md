...
Reference full template: `/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/templates/state.md`.
