...
Use template from `/Users/example/Projects/open-source/friday-clean/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Users/example/Projects/open-source/friday-clean/.claude/gsd-core/templates/UI-SPEC.md`
