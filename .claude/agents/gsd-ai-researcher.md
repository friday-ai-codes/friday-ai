...
<required_reading>
Read `/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
