...
**Verification depth scales with `asvs_level`** (see @/Users/example/Projects/open-source/friday-clean/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
