...
<required_reading>
@/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/example/Projects/open-source/friday-ai/.claude
                  → checks /Users/example/Projects/open-source/friday-ai/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/example/Projects/open-source/friday-ai/.claude/gsd-core
                  → writes to /Users/example/Projects/open-source/friday-ai/.claude/gsd-core/hooks/
...
@/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/Users/example/Projects/open-source/friday-ai/.claude/gsd-core/references/common-bug-patterns.md
