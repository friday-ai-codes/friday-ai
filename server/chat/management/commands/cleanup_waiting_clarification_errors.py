"""一次性数据修复：清理 Phase 集成漏洞导致 status=error 的 conv。
背景：work-item review round Test 2 调查发现，从 commit ``83218e04`` (Phase)
...
class Command(BaseCommand):
 help = "清理因 Phase 漏分发导致 status=error 的 conversation"
