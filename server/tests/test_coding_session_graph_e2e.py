""": CodingSession multi-confirm 端到端回归测试。
覆盖 v26.0 Phase 修复后的全链路：
...
async def test_ws_callback_resumes_graph_same_as_http(
 ...
 quick task Task 3（commit 9cf0a2d3）已修复 RunnerConsumer._handle_completed 调
