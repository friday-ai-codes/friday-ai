...
_EXAMPLE = "feat/260610.m-123456770019.示例功能专项-v1.0"
...
class TestBuildBranchName:
    ...
    def test_without_version_omits_suffix(self) -> None:
        ...
        assert name == "fix/260610.m-123456770019.示例功能专项"
...
class TestGenerateBranchName:
    ...
    async def test_llm_decides_type_and_version_server_assembles(self) -> None:
        work_item = SimpleNamespace(work_item_id="123456770019", name="示例功能专项")
