"""Phase Plan Task 1 — Execution Provider 快照集成测试。
覆盖 CONTEXT // 全链路：
...
Analog: test_node_provider_credential_resolution.py（Phase）+ fixture
 execution_with_snapshot_factory（conftest ）。
"""
...
async def test_runner_prefers_snapshot_over_runtime_resolve(
 ...
 # 手动把 snapshot dict 注入 dataclass 字段（ 设计）
