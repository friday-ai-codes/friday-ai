...
class TestProjectRepositoryLink:
 ...
 link = ProjectRepository.objects.get(
 project=project, repository=second_repository,
 )
 ...
 self, project_viewer_client: APIClient, project: Project,
 repository: Repository,
 ) -> None:
 """viewer 可查看项目关联的仓库列表。"""
 ...
 self, project_member_client: APIClient, project: Project,
 second_repository: Repository,
 ) -> None:
 """member 无法创建关联。"""
