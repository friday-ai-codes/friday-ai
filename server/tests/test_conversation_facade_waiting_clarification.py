...
分支。Phase（commit 83218e04）在 graph 加了 ``wait_clarification_node``
...
class TestDispatchSourceGuard:
 ...
 这种 source guard 在 GSD `gsd-secure-phase` 模式下是合规手段。
 """
 ...
 f"project-docs/phases/work-item/work-item item-error.md"
 )
