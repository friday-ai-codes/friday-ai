...
class TestDeprecatedNodeRegistration:
    """Chassis v2：ai_plan_generation 已删除（无向后兼容）；统一入口为 ai_plan_research。"""

    def test_ai_plan_generation_removed(self):
        """ai_plan_generation 节点已彻底删除，不再注册（Chassis v2 无 compat）。"""
