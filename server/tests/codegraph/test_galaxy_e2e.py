...
class TestE3GalaxyListEndpoint(TestCase):
 """E3: — GET /api/codegraph/galaxy/ 返回 nodes+edges+meta。"""
...
class TestE5GalaxyNodeDetail(TestCase):
 """E5: — node detail + neighbors + references + called_by。"""
...
class TestE6GalaxyDegreeBasedSampling(TestCase):
 """E6: — max_nodes=1, 3 节点 → sampled=True + per_repo_hint=True。"""
