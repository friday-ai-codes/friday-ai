"""Phase seed: repo.summary_generator prompt 入库。
决策依据（work-item.md）：
- 仿照 0002_seed_system_defaults.py 的 data migration 模式
- slug 已在 keys.py 预声明（Phase）: PromptSlugs.REPO_SUMMARY_GENERATOR
...
def forwards(apps: Any, schema_editor: Any) -> None:
 ...
 "title": "仓库智能描述生成",
 "description": "分析仓库源码并生成结构化 JSON 描述（Phase seed）",
 "is_builtin": True,
 },
 )
 if created:
 ...
 variables_schema={},
 change_note="Phase initial seed",
 )
 ...
 body=REPO_SUMMARY_PROMPT_BODY,
 variables_schema={},
 change_note=f"Phase seed sync (body drift from v{max_v})",
 )
