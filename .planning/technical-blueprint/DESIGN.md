...
**动机（实证，2026-07-29 路由试验）**：用「示例功能专项」feature list 语料（4000 字符验收清单）对 30 仓空间跑 5 轮完整 v2 路由，目标 4 仓稳定只命中 2~3 个，且偏差是**系统性**的（5 轮结果几乎一字不差）：
