...
- ✅ **v0.24.0 单仓图查询对齐 GitNexus** — Phases 133–140 (completed 2026-08-24，未打 tag) — 审计 **tech_debt**（39/39 requirements 满足 / 8 phases / 16 plans / 0 critical gaps）；真实 benchmark/Qdrant 数值验证保留为 `human_needed`，不宣称数值优于 v0.22.0 — [audit](./milestones/v0.24.0-MILESTONE-AUDIT.md) · [archive](./milestones/v0.24.0-ROADMAP.md) · [requirements](./milestones/v0.24.0-REQUIREMENTS.md)
...
<details>
<summary>✅ v0.24.0 单仓图查询对齐 GitNexus（Phases 133–140）— COMPLETED 2026-08-24</summary>
...
- [x] 133-02-PLAN.md — 冻结 gold 数据集：manifest + dev/locked_test/holdout 三切分 + 防反导 README（BENCH-02）
...
- [x] **Phase 132: 集成验收与高阶提效回归** — D2 bar + 契约不回归 + 合成反思（3/3, passed）
...
| 132. 集成验收与高阶提效回归 | v0.23.0 | 3/3 | ✅ passed | 2026-08-14 |
...
|-------|-----------|--------------|----------------|--------|-----------|
| 133. 同仓同 commit 基准与 v0.22 baseline | v0.24.0 | BENCH-01~05 | 4/4 | Complete (human_needed) | 2026-08-24 |
| 134. TS/JS resolved 调用边 | v0.24.0 | EDGE-01/02/03/07 | 2/2 | Complete | 2026-08-24 |
| 135. Python resolved 调用边 | v0.24.0 | EDGE-04/05 | 1/1 | Complete | 2026-08-24 |
| 136. Process 一等混合索引 | v0.24.0 | PROC-01~05, OBS-04 | 2/2 | Complete (human_needed) | 2026-08-24 |
...
| 132. 集成验收与高阶提效回归 | v0.23.0 | INT-02, INT-03 | 3/3 | Complete   | 2026-08-14 |
