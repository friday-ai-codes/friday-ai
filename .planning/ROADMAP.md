...
- [x] 14-02-PLAN.md — git_platform get_branch_diff 抽象方法（OQ-1 定案：GitLab repository_compare / GitHub compare+patch，skip-PR 全量 diff 兜底）
...
| 14. 全触发点接入与 diff 归档 | 2/6 | In Progress|  |
