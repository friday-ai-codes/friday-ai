...
|---------|------|------|-------------|---------|-----------------|-----------|-------------------|-------------|--------|
| 125-01 | 01 | 0 | MOD-01..04 | — | call_source 双登记；Wave 0 桩可收集 | stubs+unit | `uv run pytest tests/test_model_usage_call_source.py::TestCallSourceEnum tests/services/code_graph/test_community.py tests/services/code_graph/test_module_summary.py tests/services/code_graph/test_community_enqueue.py tests/services/code_graph/test_frozen_surface_125.py tests/codegraph/test_symbol_community_model.py tests/services/test_module_summary_signal.py tests/services/process_runtime/test_module_summary_prompt.py --collect-only -q` | ❌ W0 / ✅ enum | ⬜ pending |
| 125-02 | 02 | 1 | MOD-01 | T-125-01 | 只经 get_graph 取图；enqueue 非内联 | unit+db | `uv run pytest tests/codegraph/test_symbol_community_model.py tests/services/code_graph/test_community.py::test_louvain_seed_stable tests/services/code_graph/test_community_enqueue.py -x` | ❌ W0 | ⬜ pending |
| 125-03 | 03 | 2 | MOD-02+03 | T-125-02 | 空 summary 可重试；call_source；rebuild×2 LLM=0 | unit | `uv run pytest tests/services/code_graph/test_community.py::test_rebuild_twice_zero_llm tests/services/code_graph/test_module_summary.py -x` | ❌ W0 | ⬜ pending |
...
- [ ] Per-Task Verification Map 恰好 4 行（125-01..04），无 125-05
