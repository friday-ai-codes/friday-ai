...
| `server/tests/fixtures/blueprint_golden/assessment_boost.json` | 634 | 过 validate_blueprint；含 onion-learning/study-course/onion-practice + study-plan indirect；目录独立仅 1 个 json | ✓ VERIFIED |
