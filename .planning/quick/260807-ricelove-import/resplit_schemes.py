...
- 「示例功能专项」不动（非 ricelove，且已有 feature_list/test_case）
...
def _mark_cluster_desc(project: Project, child_names: list[str]) -> None:
    note = (
        "\n\n【能力簇容器】本项目对应示例产品知识库 Feature 合集，具体方案已拆为独立项目：\n"
    ...
    def _gaps() -> dict[str, Any]:
        ...
        return {
            ...
            "note": (
                ...
                "示例功能专项是人工录入范例。dev_spec/ui_design 仅少数文档标题可识别。"
            ),
        }
