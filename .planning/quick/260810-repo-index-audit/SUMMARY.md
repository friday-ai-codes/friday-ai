...
|---|---|---|---|---|
| backend/sample_course_service | 4467 | 694 | 207 | **2** ← 错 |
| backend/growth-order-thirdparty | 16972 | 2060 | 1592 | **0** ← 错 |
| frontend/sample_practice_service | 13148 | 2438 | 1956 | **0** ← 错 |
...
## sample_course_service 在 master 的改动（相对 feat/coding-agent-base）
