...
**Requirements:** 28 条 v1 需求，100% 交付
...
- [x] **Phase 15: 时间感知混合检索** - 向量召回 + 图扩散 + 时间衰减融合，相似需求召回与迭代轨迹查询 (completed 2026-06-12)
- [x] **Phase 16: 多入口暴露与前端时间线** - MCP 工具 / chat tools / workflow 节点 / npm skill 四入口 + 前端只读详情页与 as-of 查询 (completed 2026-06-12)
...
Plans:
- [x] 15-01-PLAN.md — DTO/权限 scope/时间衰减/GraphStore both 多跳地基
- [x] 15-02-PLAN.md — 向量分路 hybrid 召回 + is_latest filter + metadata hydrate
- [x] 15-03-PLAN.md — get_timeline 纯 PG + get_related 双向图查询
- [x] 15-04-PLAN.md — 图 enrich + search_similar 融合编排
- [x] 15-05-PLAN.md — LLM 二阶段分级 + 集成测试 + eval fixture + 内部 REST
...
Plans:
- [x] 16-01-PLAN.md — knowledge/exposure 序列化 + MCP 三工具（PAT/审计/越权/as_of）
- [x] 16-02-PLAN.md — chat agent 三工具 + langchain 装配
- [x] 16-03-PLAN.md — delivery_knowledge_search 节点 + ai_plan_generation 飞轮 hook
- [x] 16-04-PLAN.md — npm friday-knowledge skill + HTTP fallback
- [x] 16-05-PLAN.md — 前端只读实体详情页 + REST 升级 + as-of 选择器

**Wave 1**
- [x] 16-01-PLAN.md

**Wave 2** *(depends on Wave 1 — 16-01 exposure 模块)*
- [x] 16-02-PLAN.md
- [x] 16-03-PLAN.md
- [x] 16-04-PLAN.md
...
| 15. 时间感知混合检索 | 5/5 | Complete    | 2026-06-12 |
| 16. 多入口暴露与前端时间线 | 5/5 | Complete    | 2026-06-12 |
...
---
*Created: 2026-06-11*
*Milestone v0.3.0 shipped: 2026-06-12*
*Full archive: .planning/milestones/v0.3.0-ROADMAP.md*
