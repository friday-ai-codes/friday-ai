...
**Milestone:** v0.20.0
**Defined:** 2026-07-29
**Source:** `.planning/technical-blueprint/DESIGN.md`（设计蓝图，13 节，§12 八项决策已定夺）+ 示例功能专项路由试验（RepoCharter 动机实证）
...
- [x] **GATE-02**：蓝图 golden set 与质量指标基线建立（引用覆盖率 / AI 打回率 / 人审修改量 / 澄清轮次 / 目标仓命中率，首条 golden case 为示例功能专项），质量退化可被回归检出
...
| GATE-02 | Phase 111 蓝图底座 | Complete（111-04：`blueprint_quality` 指标 + 示例功能专项 golden case + `evaluate_blueprint_golden` command） |
...
**Milestone:** v0.19.0
**Defined:** 2026-07-28
**Source:** 生产实例实证排查（friday.example.com / 会话 `sess-example-01`）+ `.planning/research/ROUTING-RANKING.md`
