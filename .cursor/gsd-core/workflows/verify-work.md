...
<template>
@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/workflows/transition.md`.
...
- Follow @/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/workflows/diagnose-issues.md
