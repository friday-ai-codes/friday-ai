...
See ./.cursor/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ./.cursor/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using ./.cursor/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ./.cursor/gsd-core/templates/discovery.md
...
Use ./.cursor/gsd-core/templates/discovery.md.
