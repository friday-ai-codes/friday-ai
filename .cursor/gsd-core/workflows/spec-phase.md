...
```bash
INIT=$(node "/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/templates/spec.md.
