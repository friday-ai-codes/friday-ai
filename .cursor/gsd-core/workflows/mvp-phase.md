...
<required_reading>
@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/references/user-story-template.md
@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/references/spidr-splitting.md
@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/references/spidr-splitting.md`. Briefly:
