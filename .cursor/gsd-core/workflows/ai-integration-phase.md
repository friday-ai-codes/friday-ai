...
<required_reading>
@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/references/ai-frameworks.md
@/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-ai/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-ai/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-ai/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/zaneliu/Projects/open-source/friday-ai/.cursor/agents/gsd-eval-planner.md for instructions.
