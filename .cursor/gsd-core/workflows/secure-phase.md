...
```
Agent(
  prompt="Read /Users/zaneliu/Projects/open-source/friday-ai/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/templates/SECURITY.md`
