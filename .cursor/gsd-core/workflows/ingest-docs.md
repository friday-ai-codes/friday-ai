...
```bash
INIT=$(node "/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/zaneliu/Projects/open-source/friday-ai/.cursor/gsd-core/bin/gsd-tools.cjs" commit \
